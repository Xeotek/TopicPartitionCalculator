...
describe('TPC', () => {
  test('calculateMinimumProducerCount', () => {
    ...
    expect(calculateMinimumProducerCount({
      T: 1000,
      P: 0.001,
      L: 0.8,
      F: 0.99
  ...
  test('calculateMinimumConsumerCount', () => {
    //ceiling(1000 m/s * 0.001 s/m / 0.8 / 0.99) = 2 MP
    expect(calculateMinimumConsumerCount({
      T: 1000,
      C: 0.001,
      L: 0.8,
      F: 0.99
  ...
  test('calculateAdjustedMinimumProducerCount', () => {
    //((3 + 2 - 1) // 2) * 2 = 4
    expect(calculateAdjustedMinimumProducerCount({
      T: 1000,
      P: 0.001,
      L: 0.8,
      F: 0.99,
  ...
  test('calculateAdjustedMinimumConsumerCount', () => {
    //((3 + 2 - 1) // 2) * 2 = 4
    expect(calculateAdjustedMinimumConsumerCount({
      T: 1000,
      C: 0.001,
      L: 0.8,
      F: 0.99,
  ...
  test('calculatePartitionForTopicCount', () => {
    // B = 12, RMP = 4, RMC = 3 → 4
    expect(calculatePartitionForTopicCount({
      T: 1000,
      P: 0.002,
      C: 0.001,
      L: 0.8,
  ...
  test('calculateRecommendedNumberOfPartitions', () => {
    ...
    expect(calculateRecommendedNumberOfPartitions({
      T: 0.00001,
      P: 50,
      C: 1,
      B: 2
  ...
  test('calculateRecommendedNumberOfConsumers', () => {
    // small throughput -  0.00001
    expect(calculateRecommendedNumberOfConsumers({
      T: 0.00001,
      P: 50,
      C: 1,
      B: 2
